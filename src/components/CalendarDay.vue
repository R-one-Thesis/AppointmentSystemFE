<template>
    <div class="subcontent">
      ...
      <div class="row justify-center">
        <div style="display: flex; max-width: 100%; width: 100%; height: 600px;">
          <q-calendar-day
            ref="calendar"
          ...
          >
            ...
            <template #day-body="{ scope: { timestamp, timeStartPos, timeDurationHeight } }">
              ...
              >
                ...
                >
                  <span class="title q-calendar__ellipsis">
                    {{ event.doctor }} <br> {{ event.specialisation }} <br> {{ event.details }}
                    <q-tooltip>{{ event.details }}<br>{{ event.details2 }}</q-tooltip>
                  </span>
                </div>
              </template>
            </template>
